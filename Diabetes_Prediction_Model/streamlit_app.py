...
model = pickle.load(open('/mount/src/diabetes_prediction_svm/Diabetes_Prediction_Model/model/classifier.pkl', 'rb'))
scaler = pickle.load(open('/mount/src/diabetes_prediction_svm/Diabetes_Prediction_Model/model/scaler.pkl', 'rb'))
